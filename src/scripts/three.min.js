...
THREE.Vector4.prototype = {
  ...
  setAxisAngleFromRotationMatrix: function (a) {
    ...
    a = Math.sqrt((b - i) * (b - i) + (e - c) * (e - c) + (g - d) * (g - d));
...
THREE.Matrix4.prototype = {
  ...
  getInverse: function (a) {
    var b = this.elements,
      ...
      c = c[15];
    b[0] =
      j * p * r - l * q * r + l * m * t - i * p * t - j * m * c + i * q * c;
    b[4] =
      g * q * r - e * p * r - g * m * t + f * p * t + e * m * c - f * q * c;
    b[8] =
      e * l * r - g * j * r + g * i * t - f * l * t - e * i * c + f * j * c;
    b[12] =
      g * j * m - e * l * m - g * i * q + f * l * q + e * i * p - f * j * p;
    b[1] =
      l * q * o - j * p * o - l * n * t + h * p * t + j * n * c - h * q * c;
    b[5] =
      e * p * o - g * q * o + g * n * t - d * p * t - e * n * c + d * q * c;
    b[9] =
      g * j * o - e * l * o - g * h * t + d * l * t + e * h * c - d * j * c;
    b[13] =
      e * l * n - g * j * n + g * h * q - d * l * q - e * h * p + d * j * p;
    b[2] =
      i * p * o - l * m * o + l * n * r - h * p * r - i * n * c + h * m * c;
    b[6] =
      g * m * o - f * p * o - g * n * r + d * p * r + f * n * c - d * m * c;
    b[10] =
      f * l * o - g * i * o + g * h * r - d * l * r - f * h * c + d * i * c;
    b[14] =
      g * i * n - f * l * n - g * h * m + d * l * m + f * h * p - d * i * p;
    b[3] =
      j * m * o - i * q * o - j * n * r + h * q * r + i * n * t - h * m * t;
    b[7] =
      f * q * o - e * m * o + e * n * r - d * q * r - f * n * t + d * m * t;
    b[11] =
      e * i * o - f * j * o - e * h * r + d * j * r + f * h * t - d * i * t;
    b[15] =
      f * j * n - e * i * n + e * h * m - d * j * m - f * h * q + d * i * q;
  ...
  var b = new a.Vector3(),
    ...
    p = function (i, j, l) {
      ...
      if (i instanceof a.Particle) {
        ...
        var p =
          i.geometry.boundingSphere.radius * i.matrixWorld.getMaxScaleOnAxis();
        n = m(j.origin, j.direction, i.matrixWorld.getPosition());
        if (n > p) return l;
        var v,
          A,
        ...
        for (v = E.faces.length; p < v; p++) {
          ...
          if (n !== void 0) {
            ...
            if (!(Math.abs(n) < O)) {
              ...
              if (
                !(A < 0) &&
                (G === a.DoubleSide || (G === a.FrontSide ? n < 0 : n > 0))
              ) {
                ...
                if (o instanceof a.Face3) {
                  ...
                  G = z[o.c];
                  if (q(g, n, A, G)) {
                    A = i.matrixWorld.multiplyVector3(g.clone());
                    n = b.distanceTo(A);
                    if (!(n < j.near || n > j.far)) {
                      o = {
                        distance: n,
      ...
      for (var c = 0, d = b.children.length; c < d; c++) {
        ...
        if (e.visible !== false) {
          if (e instanceof THREE.Light) D.lights.push(e);
            ...
            if (e.frustumCulled === false || J.contains(e) === true) {
              f = a();
              f.object = e;
          ...
          } else if (e instanceof THREE.Sprite || e instanceof THREE.Particle) {
            f = a();
            f.object = e;
            if (e.renderDepth !== null) f.z = e.renderDepth;
            else {
    ...
    for (n = D.objects.length; g < n; g++) {
      ...
      if (pa instanceof THREE.Mesh) {
        ...
        for (da = ga.length; ta < da; ta++) {
          ...
          i.visible = i.positionScreen.z > ba && i.positionScreen.z < Q;
        }
        ga = 0;
        for (ta = Xa.length; ga < ta; ga++) {
          ...
          if (da !== void 0) {
              ...
              if (
                ...
                fa =
                  (ja.positionScreen.x - N.positionScreen.x) *
                    (U.positionScreen.y - N.positionScreen.y) -
                    (ja.positionScreen.y - N.positionScreen.y) *
                      (U.positionScreen.x - N.positionScreen.x) <
                  0;
                if (
                  ia === THREE.DoubleSide ||
              ...
              if (
                ...
                fa =
                  (Oa.positionScreen.x - N.positionScreen.x) *
                    (U.positionScreen.y - N.positionScreen.y) -
                    (Oa.positionScreen.y - N.positionScreen.y) *
                      (U.positionScreen.x - N.positionScreen.x) <
                    0 ||
                  (U.positionScreen.x - ja.positionScreen.x) *
                    (Oa.positionScreen.y - ja.positionScreen.y) -
                    (U.positionScreen.y - ja.positionScreen.y) *
                      (Oa.positionScreen.x - ja.positionScreen.x) <
                    0;
                if (
                  ia === THREE.DoubleSide ||
                  fa === (ia === THREE.FrontSide)
            ...
            for (U = pb.length; N < U; N++) {
              ...
              if (ja !== void 0) {
                ia = 0;
                for (Ia = ja.length; ia < Ia; ia++) m.uvs[N][ia] = ja[ia];
              }
            }
            m.material = da;
...
THREE.Geometry.prototype = {
  ...
  mergeVertices: function () {
    ...
    for (g = this.vertices.length; e < g; e++) {
      d = this.vertices[e];
      d = [Math.round(d.x * f), Math.round(d.y * f), Math.round(d.z * f)].join(
        "_"
      );
      if (a[d] === void 0) {
        a[d] = e;
    ...
    if (
      ...
      for (G = J.length; D < G; ++D) {
        ...
        for (M = M + H; z < M; z = z + 3) {
          ...
          s = E - s;
          E = 1 / (B * s - w * v);
          e.set((s * q - v * l) * E, (s * p - v * n) * E, (s * o - v * m) * E);
          g.set((B * l - w * q) * E, (B * n - w * p) * E, (B * m - w * o) * E);
          i[H].addSelf(e);
          i[O].addSelf(e);
          i[F].addSelf(e);
          j[H].addSelf(g);
  ...
  e.onreadystatechange = function () {
    if (e.readyState == 4)
      if (e.status == 200 || e.status == 0) {
        ...
        console.error(
          "THREE.BinaryLoader: Couldn't load [" + g + "] [" + e.status + "]"
        );
      ...
      for (
        ...
        O.faces.push(
          new THREE.Face3(
            ...
            h,
            [
              new THREE.Vector3(J[j * 3], J[j * 3 + 1], J[j * 3 + 2]),
      ...
      for (
        ...
        O.faces.push(
          new THREE.Face4(
            ...
            i,
            [
              new THREE.Vector3(J[l * 3], J[l * 3 + 1], J[l * 3 + 2]),
              new THREE.Vector3(q, r, n),
  ...
  e.onreadystatechange = function () {
    if (e.readyState === e.DONE)
      if (e.status === 200 || e.status === 0) {
        ...
        console.error(
          "THREE.JSONLoader: Couldn't load [" + b + "] [" + e.status + "]"
        );
  ...
  parse: function (a, b) {
    ...
    if (a.materials) {
      ...
      for (var e = 0; e < a.materials.length; ++e) {
        ...
        if (g.vertexColors !== void 0)
          if (g.vertexColors == "face") m.vertexColors = THREE.FaceColors;
          else if (g.vertexColors) m.vertexColors = THREE.VertexColors;
        ...
        if (g.mapNormal) {
          ...
          g.mapNormalFactor &&
            l.uNormalScale.value.set(g.mapNormalFactor, g.mapNormalFactor);
          if (m.map) {
    ...
    if (a.skinWeights) {
      ...
      for (g = a.skinWeights.length; e < g; e = e + 2)
        d.skinWeights.push(
          new THREE.Vector4(a.skinWeights[e], a.skinWeights[e + 1], 0, 0)
        );
    }
    if (a.skinIndices) {
      e = 0;
      for (g = a.skinIndices.length; e < g; e = e + 2) {
        m = 0;
        d.skinIndices.push(
          new THREE.Vector4(a.skinIndices[e], a.skinIndices[e + 1], m, 0)
        );
      }
    }
    d.bones = a.bones;
...
THREE.SceneLoader.prototype.parse = function (a, b, c) {
      ...
      if (I.objects[c] === void 0) {
        ...
        if (d.geometry !== void 0) {
          if ((E = I.geometries[d.geometry])) {
            ...
            (e = z instanceof THREE.ShaderMaterial) && E.computeTangents();
            u = d.position;
            w = d.rotation;
            s = d.quaternion;
            B = d.scale;
            r = d.matrix;
            s = 0;
            d.materials.length === 0 && (z = new THREE.MeshFaceMaterial());
            d.materials.length > 1 && (z = new THREE.MeshFaceMaterial());
            if (d.morph) {
              e = new THREE.MorphAnimMesh(E, z);
              if (d.duration !== void 0) e.duration = d.duration;
              if (d.time !== void 0) e.time = d.time;
              if (d.mirroredLoop !== void 0) e.mirroredLoop = d.mirroredLoop;
        ...
        if (e) {
          if (d.properties !== void 0)
            for (var g in d.properties) e.properties[g] = d.properties[g];
  ...
  for (l in K.geometries) {
    ...
    if (p.type === "cube") {
      ...
      E = new THREE.SphereGeometry(p.radius, p.segmentsWidth, p.segmentsHeight);
      I.geometries[l] = E;
      ...
      E = new THREE.TorusGeometry(p.radius, p.tube, p.segmentsR, p.segmentsT);
      I.geometries[l] = E;
      ...
      p && this.geometryHandlerMap.ascii.loaderObject.createModel(p, g(l), "");
    }
  }
  for (o in K.textures) {
    l = K.textures[o];
  ...
  for (n in K.materials) {
    ...
    for (A in r.parameters)
      if (A === "envMap" || A === "map" || A === "lightMap" || A === "bumpMap")
        r.parameters[A] = I.textures[r.parameters[A]];
      else if (A === "shading")
        r.parameters[A] =
          r.parameters[A] === "flat" ? THREE.FlatShading : THREE.SmoothShading;
      else if (A === "side")
        r.parameters[A] =
        ...
        if (r.parameters[A] == "face") r.parameters[A] = THREE.FaceColors;
        else {
    ...
    if (r.parameters.normalMap) {
      ...
      if (r.parameters.displacementMap) {
        a.tDisplacement.value = I.textures[r.parameters.displacementMap];
  ...
  this.render = function (a, k) {
        ...
        if (e instanceof THREE.DirectionalLight) {
          ...
          if (!(k <= 0)) {
            k =
              ...
              (e.distance == 0
                ? 1
                : 1 - Math.min(a.distanceTo(h) / e.distance, 1));
            if (k != 0) {
              k = k * e.intensity;
              c.r = c.r + g.r * k;
              c.g = c.g + g.g * k;
    ...
    function n(a, d, f, g, h, i, j, o) {
      ...
      if (
        ...
        o.wireframe === true
          ? s(da, o.wireframeLinewidth, o.wireframeLinecap, o.wireframeLinejoin)
          : t(da);
      }
    }
      ...
      if (
        ...
        if (va === 0) {
          if (pa[m.id] === void 0) {
            ...
            pa[m.id] = b.getImageData(0, 0, m.image.width, m.image.height).data;
          }
          b = pa[m.id];
          ...
          if (B instanceof THREE.RenderableParticle) {
            ...
            if (X instanceof THREE.ParticleBasicMaterial)
              if (X.map === null) {
                ...
                jb = jb * oa.scale.x * q;
                kb = kb * oa.scale.y * p;
                xa.set(ca.x - jb, ca.y - kb, ca.x + jb, ca.y + kb);
            ...
            fb.intersects(xa) === true && n(z, M, D, 0, 1, 2, B, X, a);
                ...
                if (
                  ...
                  if (qb === true) {
                    ...
                    if (
                      ...
                      l(ca.v1.positionWorld, ca.vertexNormalsWorld[0], ga);
                      l(ca.v2.positionWorld, ca.vertexNormalsWorld[1], N);
                      l(ca.v4.positionWorld, ca.vertexNormalsWorld[3], U);
                      l(ca.v3.positionWorld, ca.vertexNormalsWorld[2], ia);
                      ga.r = oa.r * ga.r + Ea.r;
                      ga.g = oa.g * ga.g + Ea.g;
                      ga.b = oa.b * ga.b + Ea.b;
                      N.r = oa.r * N.r + Ea.r;
                      ...
                      m(ba, Q, V, Y, fa, ta);
                      w(ba, Q, V, Y, fa, ta, 1, 0, 1, 1, 0, 1, Ja);
                    } else {
                      da.r = Ga.r;
                      da.g = Ga.g;
                      da.b = Ga.b;
                      l(ca.centroidWorld, ca.normalWorld, da);
                      da.r = oa.r * da.r + Ea.r;
                      da.g = oa.g * da.g + Ea.g;
                      da.b = oa.b * da.b + Ea.b;
                      r(F, J, I, K, V, Y, $, L);
                  ...
                  X.wireframe === true
                    ...
                    : t(X.color);
                } else if (X instanceof THREE.MeshNormalMaterial) {
                  ...
                  ua = k.near;
                  Ca = k.far;
                  ga.r = ga.g = ga.b = 1 - fc(oa.positionScreen.z, ua, Ca);
                  N.r = N.g = N.b = 1 - fc(Ea.positionScreen.z, ua, Ca);
                  U.r = U.g = U.b = 1 - fc(jb.positionScreen.z, ua, Ca);
                  ia.r = ia.g = ia.b = 1 - fc(tb.positionScreen.z, ua, Ca);
                  Ja = va(ga, N, U, ia);
                  m(F, J, I, K, $, L);
                  w(F, J, I, K, $, L, 0, 0, 1, 0, 0, 1, Ja);
                  m(ba, Q, V, Y, fa, ta);
...
THREE.WebGLRenderer = function (a) {
      ...
      if (q) {
        ...
        for (j = q.length; i < j; i++) {
          ...
          if (
            ...
            f = h.value.length;
            e = 0;
            if (h.size === 1) for (d = 0; d < f; d++) h.array[d] = h.value[d];
            else if (h.size === 2)
              for (d = 0; d < f; d++) {
                g = h.value[d];
                h.array[e] = g.x;
    ...
    for (var m = k; m !== b; m = m + l) {
      ...
      if (i.render) {
        ...
        if (h) i = h;
          ...
          if (!i) continue;
          g &&
            Q.setBlending(i.blending, i.blendEquation, i.blendSrc, i.blendDst);
  ...
  function u(a, b, c, d, f) {
    ...
    if (d.morphTargets && !f.__webglMorphTargetInfluences)
      f.__webglMorphTargetInfluences = new Float32Array(Q.maxMorphTargets);
    var e = false,
      g = d.program,
      h = g.uniforms,
      i = d.uniforms;
          ...
          for (
            ...
            if (!j.onlyShadow && j.visible) {
              ...
              if (j instanceof THREE.AmbientLight)
                ...
                p = V * 3;
                Q.gammaInput ? B(t, p, o, r * r) : v(t, p, o, r);
                ...
                q = $ * 3;
                Q.gammaInput ? B(z, q, o, r * r) : v(z, q, o, r);
                ...
                q = ba * 3;
                Q.gammaInput ? B(D, q, o, r * r) : v(D, q, o, r);
                r = j.matrixWorld.getPosition();
                G[q] = r.x;
                G[q + 1] = r.y;
                G[q + 2] = r.z;
      ...
      for (fa = b.length; i < fa; i++)
        if ((e = g.uniforms[b[i][1]])) {
          ...
          if (l === "i") k.uniform1i(e, j);
            ...
            if (c._array === void 0) c._array = new Float32Array(2 * j.length);
            l = 0;
            ...
            if (c._array === void 0) c._array = new Float32Array(3 * j.length);
            l = 0;
            for (m = j.length; l < m; l++) {
              n = l * 3;
              c._array[n] = j[l].x;
            ...
            if (c._array === void 0) c._array = new Float32Array(4 * j.length);
            l = 0;
            for (m = j.length; l < m; l++) {
              n = l * 4;
              c._array[n] = j[l].x;
            ...
            if (c._array === void 0) c._array = new Float32Array(16);
            j.flattenToArray(c._array);
            k.uniformMatrix4fv(e, false, c._array);
          } else if (l === "m4v") {
            if (c._array === void 0) c._array = new Float32Array(16 * j.length);
            l = 0;
            for (m = j.length; l < m; l++)
            ...
            if (n)
                    ...
                    for (l = 0; l < 6; l++)
                      if (Q.autoScaleCubemaps && !e) {
                        ...
                        if (!(s.width <= u && s.height <= u)) {
                          ...
                          t = Math.floor((s.width * u) / z);
                          u = Math.floor((s.height * u) / z);
              ...
              } else if (n instanceof THREE.WebGLRenderTargetCube) {
                c = n;
  ...
  var a = a || {},
    ...
    Y = a.preserveDrawingBuffer !== void 0 ? a.preserveDrawingBuffer : false,
    $ =
      a.clearColor !== void 0
  ...
  J || console.log("THREE.WebGLRenderer: Standard derivatives not supported.");
  Pb ||
    console.log(
        ...
        for (c = f.length; d < c; ++d) {
          ...
          if (b) {
            ...
            if (a.color >= 0 && i) {
              var j = i.itemSize;
              k.bindBuffer(k.ARRAY_BUFFER, i.buffer);
              k.vertexAttribPointer(a.color, j, k.FLOAT, false, 0, g * j * 4);
            }
          ...
          Q.info.render.calls++;
          Q.info.render.vertices = Q.info.render.vertices + f[d].count;
  ...
  this.renderBuffer = function (a, b, c, d, e, f) {
    if (d.visible !== false) {
      ...
      if (!d.morphTargets && b.position >= 0) {
        ...
        if (f.morphTargetForcedOrder.length) {
          ...
          for (
            ...
            if (d.morphNormals) {
              k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[h[i]]);
              k.vertexAttribPointer(
                c["morphNormal" + i],
                3,
                k.FLOAT,
          ...
          for (i = 0; i < d.numSupportedMorphTargets; ) {
            if (h[i]) {
              l = h[i][0];
              k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphTargetsBuffers[l]);
              k.vertexAttribPointer(
                c["morphTarget" + i],
                3,
                k.FLOAT,
              ...
              if (d.morphNormals) {
                k.bindBuffer(k.ARRAY_BUFFER, e.__webglMorphNormalsBuffers[l]);
                k.vertexAttribPointer(
                  c["morphNormal" + i],
                  3,
                  k.FLOAT,
      ...
      if (f instanceof THREE.Mesh) {
        ...
        Q.info.render.calls++;
        Q.info.render.vertices = Q.info.render.vertices + e.__webglFaceCount;
        Q.info.render.faces = Q.info.render.faces + e.__webglFaceCount / 3;
        ...
        Q.info.render.calls++;
        Q.info.render.points = Q.info.render.points + e.__webglParticleCount;
  ...
  this.initWebGLObjects = function (a) {
    ...
    for (; a.__objectsAdded.length; ) {
          ...
          if (m instanceof THREE.Geometry) {
            if (m.geometryGroups === void 0) {
              ...
              for (v = s.faces.length; u < v; u++) {
                ...
                z = w.materialIndex;
                B = z !== void 0 ? z : -1;
                D[B] === void 0 && (D[B] = { hash: B, counter: 0 });
                ...
                s.geometryGroups[E].vertices = s.geometryGroups[E].vertices + A;
              }
              ...
              if (!n.__webglVertexBuffer) {
                ...
                if (F.numMorphTargets) {
                  ...
                  for (J = F.numMorphTargets; L < J; L++)
                    F.__webglMorphTargetsBuffers.push(k.createBuffer());
                }
                if (F.numMorphNormals) {
                  F.__webglMorphNormalsBuffers = [];
                  L = 0;
                  for (J = F.numMorphNormals; L < J; L++)
                    F.__webglMorphNormalsBuffers.push(k.createBuffer());
                }
                Q.info.memory.geometries++;
                var N = n,
                  K = i,
                  ...
                  ba = f($),
                  ia = d($),
                  fa = $.vertexColors ? $.vertexColors : false;
                N.__vertexArray = new Float32Array(U * 3);
                if (ia) N.__normalArray = new Float32Array(U * 3);
                if (M.hasTangents) N.__tangentArray = new Float32Array(U * 4);
                if (fa) N.__colorArray = new Float32Array(U * 3);
                if (ba) {
                  if (M.faceUvs.length > 0 || M.faceVertexUvs.length > 0)
                    N.__uvArray = new Float32Array(U * 2);
                  if (M.faceUvs.length > 1 || M.faceVertexUvs.length > 1)
                ...
                if (
                  ...
                  N.__skinIndexArray = new Float32Array(U * 4);
                  N.__skinWeightArray = new Float32Array(U * 4);
                }
                ...
                if (N.numMorphTargets) {
                  ...
                  for (pa = N.numMorphTargets; Y < pa; Y++)
                    N.__morphTargetsArrays.push(new Float32Array(U * 3));
                }
                if (N.numMorphNormals) {
                  N.__morphNormalsArrays = [];
                  Y = 0;
                  for (pa = N.numMorphNormals; Y < pa; Y++)
                    N.__morphNormalsArrays.push(new Float32Array(U * 3));
                }
                N.__webglFaceCount = ga * 3;
                N.__webglLineCount = V * 2;
                if ($.attributes) {
                  if (N.__webglCustomAttributesList === void 0)
      ...
      if (!i.__webglActive) {
        if (i instanceof THREE.Mesh) {
          m = i.geometry;
          if (m instanceof THREE.BufferGeometry) q(j.__webglObjects, m, i);
          else
            for (l in m.geometryGroups) {
              n = m.geometryGroups[l];
          ...
          i instanceof THREE.ImmediateRenderObject || i.immediateRenderCallback
            ...
            : i instanceof THREE.LensFlare && j.__webglFlares.push(i);
    ...
    for (var hb = 0, rb = a.__webglObjects.length; hb < rb; hb++) {
      ...
      if (ub instanceof THREE.Mesh)
        if (ea instanceof THREE.BufferGeometry) {
          ...
          for (var qb = 0, wb = ea.geometryGroupsList.length; qb < wb; qb++) {
            ...
            if (
              ...
              if (la.__inittedArrays) {
                var Pb = d(gb),
                  ec = gb.vertexColors ? gb.vertexColors : false,
                  ic = f(gb),
                ...
                if (id) {
                  ...
                  for (rc = bc.length; Ra < rc; Ra++) {
                    ...
                    for (W = ma.length; C < W; C++) {
                      ...
                      if (gb.morphNormals) {
                        if (Fc) {
                          Rb = Hc[Ra].vertexNormals[$b];
                          Cb = Rb.a;
                          Db = Rb.b;
                          Eb = Rb.c;
                        } else Eb = Db = Cb = Hc[Ra].faceNormals[$b];
                        Na = Vc[Ra];
                        Na[ha] = Cb.x;
                        Na[ha + 1] = Cb.y;
                        Na[ha + 2] = Cb.z;
                    ...
                    for (W = na.length; C < W; C++) {
                      ...
                      if (gb.morphNormals) {
                        if (Fc) {
                          ...
                          Eb = Rb.c;
                          tc = Rb.d;
                        } else tc = Eb = Db = Cb = Hc[Ra].faceNormals[$b];
                        Na = Vc[Ra];
                        Na[ha] = Cb.x;
                        Na[ha + 1] = Cb.y;
                        Na[ha + 2] = Cb.z;
                    ...
                    k.bufferData(k.ARRAY_BUFFER, Uc[Ra], mb);
                    if (gb.morphNormals) {
                      k.bindBuffer(
                        k.ARRAY_BUFFER,
                        la.__webglMorphNormalsBuffers[Ra]
                      );
                      k.bufferData(k.ARRAY_BUFFER, Vc[Ra], mb);
                    }
                  }
                }
                if (ac.length) {
                  ...
                  if (aa > 0) {
                    k.bindBuffer(k.ARRAY_BUFFER, la.__webglSkinIndicesBuffer);
                    k.bufferData(k.ARRAY_BUFFER, za, mb);
                    k.bindBuffer(k.ARRAY_BUFFER, la.__webglSkinWeightsBuffer);
                ...
                if (hd && ec) {
                  ...
                  for (W = ma.length; C < W; C++) {
                    ...
                    vb = P.vertexColors;
                    Gc = P.color;
                    if (vb.length === 3 && ec === THREE.VertexColors) {
                      Fb = vb[0];
                      Gb = vb[1];
                      Hb = vb[2];
                    } else Hb = Gb = Fb = Gc;
                  ...
                  for (W = na.length; C < W; C++) {
                    ...
                    vb = P.vertexColors;
                    Gc = P.color;
                    if (vb.length === 4 && ec === THREE.VertexColors) {
                      Fb = vb[0];
                      Gb = vb[1];
                      Hb = vb[2];
                      uc = vb[3];
                  ...
                  if (Ka > 0) {
                    k.bindBuffer(k.ARRAY_BUFFER, la.__webglColorBuffer);
                ...
                if (ad && Xc && ic) {
                  ...
                  if (Sb > 0) {
                    k.bindBuffer(k.ARRAY_BUFFER, la.__webglUVBuffer);
                ...
                if (ad && Yc && ic) {
                  ...
                  if (Tb > 0) {
                    k.bindBuffer(k.ARRAY_BUFFER, la.__webglUV2Buffer);
                ...
                if (Dc) {
                  ...
                  k.bufferData(k.ELEMENT_ARRAY_BUFFER, ib, mb);
                }
                if (Wc) {
                  qa = 0;
                    ...
                    if (x.__original.needsUpdate) {
                      ...
                      if (x.size === 1)
                        if (x.boundTo === void 0 || x.boundTo === "vertices") {
                          ...
                          for (W = ma.length; C < W; C++) {
                            P = Wa[ma[C]];
                            x.array[y] = x.value[P.a];
                            x.array[y + 1] = x.value[P.b];
                            x.array[y + 2] = x.value[P.c];
                            y = y + 3;
                          }
                          C = 0;
                          for (W = na.length; C < W; C++) {
                      ...
                      k.bufferData(k.ARRAY_BUFFER, x.array, mb);
                    }
                  }
                }
                if (yb) {
        ...
        if (ea.verticesNeedUpdate || ea.colorsNeedUpdate || ab) {
          ...
          if ($c) {
            ...
            for (gd = $c.length; Qc < gd; Qc++) {
              ...
              if (
                wa.needsUpdate &&
                (wa.boundTo === void 0 || wa.boundTo === "vertices")
              ) {
                Ba = 0;
                pc = wa.value.length;
                if (wa.size === 1)
                  for (Ua = 0; Ua < pc; Ua++) wa.array[Ua] = wa.value[Ua];
                else if (wa.size === 2)
                  for (Ua = 0; Ua < pc; Ua++) {
                    eb = wa.value[Ua];
                    wa.array[Ba] = eb.x;
  ...
  this.initMaterial = function (a, b, c, d) {
    ...
    a: {
      ...
      d = [
        ...
        Q.physicallyBasedShading ? "#define PHYSICALLY_BASED_SHADING" : "",
  ...
  triangulateQuads: function (a) {
    ...
    for (c = a.faces.length; b < c; b++) {
      ...
      if (d instanceof THREE.Face4) {
        ...
        e.push(d);
        d = 0;
        for (f = a.faceUvs.length; d < f; d++) g[d].push(a.faceUvs[d][b]);
        d = 0;
        for (f = a.faceVertexUvs.length; d < f; d++)
          ...
          for (g = a.faceVertexUvs.length; e < g; e++)
            if (a.faceVertexUvs[e].length) {
              ...
              if (f === 0) {
                ...
                n = w.clone();
                n.lerpSelf(j, 0.5);
                s = [s.clone(), l.clone(), n.clone(), j.clone()];
                h = [l.clone(), h.clone(), w.clone(), n.clone()];
              } else {
                l = h.clone();
                l.lerpSelf(w, 0.5);
                n = j.clone();
                n.lerpSelf(s, 0.5);
                s = [s.clone(), h.clone(), l.clone(), n.clone()];
                h = [n.clone(), l.clone(), w.clone(), j.clone()];
              }
              v[e].push(s, h);
            }
        } else {
...
THREE.SceneUtils = {
  ...
  cloneObject: function (a) {
    ...
    if (a instanceof THREE.MorphAnimMesh) {
      ...
      b = new THREE.SkinnedMesh(a.geometry, a.material, a.useVertexTexture);
...
THREE.FontUtils.generateShapes = function (a, b) {
  ...
  d = [];
  f = 0;
  for (e = c.length; f < e; f++) Array.prototype.push.apply(d, c[f].toShapes());
  return d;
};
(function (a) {
  var b = function (a) {
      ...
      for (var q = 0; q < 3; q++) {
        ...
        if (h.time <= l) {
          if (j < l)
            if (this.loop) {
              ...
              for (h = this.getNextKeyWith(c, n, 1); h.time < j; ) {
                g = h;
        ...
        if (c === "pos") {
          ...
          if (this.interpolationType === THREE.AnimationHandler.LINEAR) {
            ...
            this.points[0] = this.getPrevKeyWith("pos", n, g.index - 1).pos;
            this.points[1] = f;
            this.points[2] = e;
        ...
        } else if (c === "rot") THREE.Quaternion.slerp(f, e, a.quaternion, d);
        else if (c === "scl") {
          c = a.scale;
          c.x = f[0] + (e[0] - f[0]) * d;
          c.y = f[1] + (e[1] - f[1]) * d;
      ...
      if (d.enabled) {
        ...
        if (g === -1) {
          ...
          g === 0 && !d.noRotate
            ...
            : g === 1 && !d.noZoom
            ? (l = n = d.getMouseOnScreen(a.clientX, a.clientY))
            : this.noPan || (m = q = d.getMouseOnScreen(a.clientX, a.clientY));
        }
      }
    },
    false
  ...
  function i(a, b, c, g, h, i, l, m) {
    ...
    for (h = 0; h < p; h++)
      for (i = 0; i < o; i++) {
        ...
        a.normal.copy(L);
        a.vertexNormals.push(L.clone(), L.clone(), L.clone(), L.clone());
        a.materialIndex = m;
        j.faces.push(a);
...
THREE.ExtrudeGeometry.prototype.addShape = function (a, b) {
  ...
  for (F = l - 1; F >= 0; F--) {
    ...
    for (z = q.length; E < z; E++) {
      ...
      for (ba = A.length; L < ba; L++) {
        K = c(A[L], fa[L], J);
        o ? e(K.x, K.y + p[m - 1].y, p[m - 1].x + I) : e(K.x, K.y, h + I);
      }
    }
  }
  if (n) {
...
THREE.TubeGeometry = function (a, b, c, d, f, e) {
  ...
  for (b = 0; b < this.segments; b++)
    for (d = 0; d < this.segmentsRadius; d++) {
      ...
      p = new THREE.UV((b + 1) / this.segments, (d + 1) / this.segmentsRadius);
...
THREE.PolyhedronGeometry = function (a, b, c, d) {
  ...
  function g(a, b) {
    ...
    c === void 0 &&
      (n[a.index][b.index] = n[b.index][a.index] = c = f(
        new THREE.Vector3().add(a, b).divideScalar(2)
      ));
    return c;
  }
  function h(a, b, c) {
    ...
    if (u) {
      ...
      for (G = 0; G < u; G++) {
        ...
        if (j || (M.x > 0 && M.x < f && M.y > 0 && M.y < t)) {
          ...
          b.bindTexture(b.TEXTURE_2D, h);
          b.copyTexImage2D(b.TEXTURE_2D, 0, b.RGB, M.x - 8, M.y - 8, 16, 16, 0);
          ...
          for (O = F.lensFlares.length; H < O; H++) {
            ...
            if (J.opacity > 0.001 && J.scale > 0.001) {
              ...
              b.uniform3f(D.color, J.color.r, J.color.g, J.color.b);
              c.setBlending(
                J.blending,
                J.blendEquation,
                J.blendSrc,
      ...
      if (p.castShadow)
        if (p instanceof THREE.DirectionalLight && p.shadowCascade)
          for (r = 0; r < p.shadowCascadeCount; r++) {
            var v;
            if (p.shadowCascadeArray[r]) v = p.shadowCascadeArray[r];
            else {
              s = p;
              u = r;
    ...
    for (q = B.length; m < q; m++) {
      ...
      for (o = s.length; p < o; p++) {
        ...
        if (
          t.visible &&
          t.castShadow &&
          (!(t instanceof THREE.Mesh) || !t.frustumCulled || g.contains(t))
        ) {
...
THREE.SpritePlugin = function () {
  ...
  this.render = function (d, f, q, p) {
    ...
    if (o) {
      ...
      b.bindBuffer(b.ELEMENT_ARRAY_BUFFER, g);
      b.uniformMatrix4fv(t.projectionMatrix, false, f._projectionMatrixArray);
      b.activeTexture(b.TEXTURE0);
      b.uniform1i(t.map, 0);
      for (var B, v = [], r = 0; r < o; r++) {
        ...
        if (B.visible && B.opacity !== 0)
          if (B.useScreenCoordinates) B.z = -B.position.z;
            ...
            B._modelViewMatrix.multiply(f.matrixWorldInverse, B.matrixWorld);
      ...
      for (r = 0; r < o; r++) {
        ...
        if (
          ...
          if (B.useScreenCoordinates) {
            ...
            b.uniform1i(t.affectedByDistance, B.affectedByDistance ? 1 : 0);
            b.uniformMatrix4fv(
              t.modelViewMatrix,
              false,
...
THREE.DepthPassPlugin = function () {
  ...
  this.update = function (g, h) {
    ...
    for (j = q.length; i < j; i++) {
      ...
      if (
        m.visible &&
        (!(m instanceof THREE.Mesh) || !m.frustumCulled || f.contains(m))
      ) {
